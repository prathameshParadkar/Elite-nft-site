...
export default function StudioServices() {
    ...
    return (
        <div className='w-full flex flex-col pb-10 items-center '>
            <h1 className="styled-text font-['Furore'] text-6xl mobile:text-3xl w-full text-center pt-8 z-[10]">
                OUR SEVRICES
            </h1>

            <p className="text-white font-['Lexend'] w-3/4 text-center mt-10 z-[10]">
