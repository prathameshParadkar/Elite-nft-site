        ...
        <div className='overflow-hidden'>
            ...
            <div className='h-screen w-full flex p-10 justify-center tablet:justify-between '>
                <div style={{ backgroundImage: `url(${points.src})` }} className={`h-full w-1/2 tablet:w-2/3 tablet:h-2/3 bg-contain bg-no-repeat text-white styled-text ${lato.className} text-2xl`}>
                    <h3 data-aos="fade-right" className=' ml-20 tablet:text-base '>
                        Launch Various Collections that will make it super easy For community to Navigate through Web3
                    </h3>
                    <h3 data-aos="fade-right" className='ml-64 mt-32 tablet:text-base tablet:ml-[18.2rem] tablet:mt-44'>
                        Drop Top Notch Content to <br className='tablet:hidden' />
                        create a Genuine Community
                    </h3>
                    <h3 data-aos="fade-right" className='ml-20 mt-32 tablet:text-base tablet:mt-40'>

                        Launch Various Collections that will make it super easy For community to Navigate through Web3
                    </h3>
                    <h3 data-aos="fade-right" className='mt-32 ml-64 tablet:text-base tablet:ml-[18.2rem] tablet:mt-40 '>
                        Figure Out more ways to help <br className='tablet:hidden' />
                        Community Navigate
                    </h3>
                </div>
                <Image data-aos="fade-left" height={700} className="tablet:h-[400px] tablet:w-[100px]" src={vision} alt="vision map" />


            </div>
            <div className='space-y-[-50px]'>
                <h1 data-aos="fade-up" className="styled-text font-['Furore'] text-6xl w-full text-center pt-8 ">
