                ...
                <div className='flex pb-32 mobile:pb-20 justify-center items-center'>
                    ...
                    <div className='flex tablet:flex-col-reverse  tablet:mt-12 justify-center items-center'>
                        <div className='text-center tablet:block text-white'>
                            <button data-aos="fade-up" className='font-["Furore"] px-20 py-4 desktop:hidden rounded-lg 
                            tablet:mt-14 text-xl bg-[#7534FF] discord-button-style mobile:text-sm mobile:px-10 mobile:py-2 '>
                                SUBSCRIBE TO NEWS LETTER
                            </button>
                        </div>
                        <div data-aos={props.isMobile ? "fade-up" : "fade-right"} className='news-card rounded-[50px] p-4 desktop:w-[30rem] desktop:h-[30rem]'>
                        ...
                        <div className='font-["Furore"] text-white flex flex-col tablet:items-center'>
                            ...
                            <p data-aos={props.isMobile ? "fade-up" : "fade-left"} className={`text-center ${lato.className} text-3xl 
                            ...
                            <h1 data-aos={props.isMobile ? "fade-up" : "fade-left"} className='text-center text-4xl mobile:text-lg styled-text tablet:mb-14'>
                                &quot;SUBSCRIBE NOW&quot;
                            </h1>

                            <div  className='text-center mt-10 tablet:hidden'>
                                <button data-aos="fade-left" className='font-["Furore"] px-20 py-4 rounded-lg text-xl discord-button-style  border-white border-[1px] border-solid hover:border-[#7534FF]  fill fill-button'>
                                    SUBSCRIBE TO NEWS LETTER
                                </button>
                            </div>
                        </div>
